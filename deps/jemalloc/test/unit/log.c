...
static void update_log_var_names(const char *names) {
...
int main(void) {
    return test(
        test_log_disabled, test_log_enabled_direct, test_log_enabled_indirect, test_log_enabled_global, test_logs_if_no_init,
