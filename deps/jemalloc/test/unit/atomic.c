...
#define DO_TESTS(t, ta, val1, val2, val3)                                                                        \
    do {                                                                                                         \
        ...
        expect_b_eq(val1 == val2, success, "Weak CAS did the wrong state update");                               \
        val = atomic_load_##ta(&atom, ATOMIC_RELAXED);                                                           \
        if (success) {                                                                                           \
            expect_##ta##_eq(val3, val, "Successful CAS should update atomic");                                  \
        } else {                                                                                                 \
            expect_##ta##_eq(val1, val, "Unsuccessful CAS should not update atomic");                            \
        }                                                                                                        \
                                                                                                                 \
        /* Strong CAS. */                                                                                        \
        atomic_store_##ta(&atom, val1, ATOMIC_RELAXED);                                                          \
        ...
        expect_b_eq(val1 == val2, success, "Strong CAS did the wrong state update");                             \
        val = atomic_load_##ta(&atom, ATOMIC_RELAXED);                                                           \
        if (success) {                                                                                           \
            expect_##ta##_eq(val3, val, "Successful CAS should update atomic");                                  \
        } else {                                                                                                 \
