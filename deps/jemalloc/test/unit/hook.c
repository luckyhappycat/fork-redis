...
static void expect_args_raw(uintptr_t *args_raw_expected, int nargs) {
...
static void test_expand_hook(
    void *extra, hook_expand_t type, void *address, size_t old_usize, size_t new_usize, uintptr_t result_raw, uintptr_t args_raw[4]
) {
    call_count++;
    arg_extra = extra;
    arg_type = (int)type;
...
TEST_BEGIN(test_hooks_basic) {
    ...
    expect_d_eq((int)hook_alloc_posix_memalign, arg_type, "Passed wrong alloc type");
    ...
    expect_d_eq((int)hook_dalloc_sdallocx, arg_type, "Passed wrong dalloc type");
...
TEST_BEGIN(test_hooks_alloc_simple) {
    ...
    expect_u64_eq((uintptr_t)ptr, (uintptr_t)arg_result_raw, "Wrong raw result");
    ...
    expect_ptr_eq(ptr, arg_result, "Wrong result");
    expect_u64_eq((uintptr_t)err, (uintptr_t)arg_result_raw, "Wrong raw result");
    ...
    expect_u64_eq((uintptr_t)ptr, (uintptr_t)arg_result_raw, "Wrong raw result");
    expect_u64_eq((uintptr_t)1, arg_args_raw[0], "Wrong argument");
    expect_u64_eq((uintptr_t)MALLOCX_LG_ALIGN(10), arg_args_raw[1], "Wrong flags");
    free(ptr);
...
TEST_BEGIN(test_hooks_dalloc_simple) {
    ...
    expect_ptr_eq(ptr, arg_address, "Wrong pointer freed");
    expect_u64_eq((uintptr_t)ptr, arg_args_raw[0], "Wrong raw arg");
    expect_u64_eq((uintptr_t)MALLOCX_TCACHE_NONE, arg_args_raw[1], "Wrong raw arg");
    ...
    expect_u64_eq((uintptr_t)MALLOCX_TCACHE_NONE, arg_args_raw[2], "Wrong raw arg");
...
static void do_realloc_test(void *(*ralloc)(void *, size_t, int), int flags, int expand_type, int dalloc_type) {
    ...
    expect_u64_eq((uintptr_t)2 * 1024 * 1024, arg_args_raw[1], "Wrong argument");
    free(ptr);
    ...
    expect_u64_eq((uintptr_t)ptr2, (uintptr_t)arg_result_raw, "Wrong raw result");
    expect_u64_eq((uintptr_t)ptr, arg_args_raw[0], "Wrong argument");
...
int main(void) {
    ...
    return test_no_reentrancy(
        test_hooks_basic, test_hooks_null, test_hooks_remove, test_hooks_alloc_simple, test_hooks_dalloc_simple, test_hooks_expand_simple,
        test_hooks_realloc_as_malloc_or_free, test_hooks_realloc, test_hooks_rallocx
    );
}
