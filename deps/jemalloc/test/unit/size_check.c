...
void *test_invalid_size_pre(size_t sz) {
...
void test_invalid_size_post(void) {
...
int main(void) {
    return test(test_invalid_size_sdallocx, test_invalid_size_sdallocx_nonzero_flag, test_invalid_size_sdallocx_noflags);
}
