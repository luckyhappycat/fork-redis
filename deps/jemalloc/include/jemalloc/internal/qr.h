...
#define qr_meld(a_qr_a, a_qr_b, a_field)                                           \
    do {                                                                           \
        (a_qr_b)->a_field.qre_prev->a_field.qre_next = (a_qr_a)->a_field.qre_prev; \
        (a_qr_a)->a_field.qre_prev = (a_qr_b)->a_field.qre_prev;                   \
        (a_qr_b)->a_field.qre_prev = (a_qr_b)->a_field.qre_prev->a_field.qre_next; \
 ...
 * meld.
 */
#define qr_before_insert(a_qrelm, a_qr, a_field) qr_meld((a_qrelm), (a_qr), a_field)

/* Ditto, but inserting after rather than before. */
#define qr_after_insert(a_qrelm, a_qr, a_field) qr_before_insert(qr_next(a_qrelm, a_field), (a_qr), a_field)
 ...
 * single-element ring.
 */
#define qr_remove(a_qr, a_field) qr_split(qr_next(a_qr, a_field), (a_qr), a_field)
...
#define qr_foreach(var, a_qr, a_field) \
    for ((var) = (a_qr); (var) != NULL; (var) = (((var)->a_field.qre_next != (a_qr)) ? (var)->a_field.qre_next : NULL))
...
#define qr_reverse_foreach(var, a_qr, a_field) \
    for ((var) = ((a_qr) != NULL) ? qr_prev(a_qr, a_field) : NULL; (var) != NULL; (var) = (((var) != (a_qr)) ? (var)->a_field.qre_prev : NULL))
