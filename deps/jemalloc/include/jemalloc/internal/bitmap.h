...
#define BITMAP_INFO_INITIALIZER(nbits)                                                                                                          \
    {                                                                                                                                           \
        /* nbits. */                                                                                                                            \
        nbits, /* nlevels. */                                                                                                                   \
            (BITMAP_GROUPS_L0(nbits) > BITMAP_GROUPS_L1(nbits)) + (BITMAP_GROUPS_L1(nbits) > BITMAP_GROUPS_L2(nbits)) +                         \
                (BITMAP_GROUPS_L2(nbits) > BITMAP_GROUPS_L3(nbits)) + (BITMAP_GROUPS_L3(nbits) > BITMAP_GROUPS_L4(nbits)) + 1, /* levels. */    \
        {                                                                                                                                       \
            {0}, {BITMAP_GROUPS_L0(nbits)}, {BITMAP_GROUPS_L1(nbits) + BITMAP_GROUPS_L0(nbits)},                                                \
                ...
                {BITMAP_GROUPS_L3(nbits) + BITMAP_GROUPS_L2(nbits) + BITMAP_GROUPS_L1(nbits) + BITMAP_GROUPS_L0(nbits)}, {                      \
