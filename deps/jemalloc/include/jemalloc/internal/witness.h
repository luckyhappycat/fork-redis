...
static inline unsigned witness_depth_to_rank(witness_list_t *witnesses, witness_rank_t rank_inclusive) {
    unsigned d = 0;
...
static inline void witness_assert_positive_depth_to_rank(witness_tsdn_t *witness_tsdn, witness_rank_t rank_inclusive) {
    if (!config_debug || witness_tsdn_null(witness_tsdn)) {
        return;
    }
