...
static inline bool exp_grow_size_prepare(exp_grow_t *exp_grow, size_t alloc_size_min, size_t *r_alloc_size, pszind_t *r_skip) {
    *r_skip = 0;
...
static inline void exp_grow_size_commit(exp_grow_t *exp_grow, pszind_t skip) {
