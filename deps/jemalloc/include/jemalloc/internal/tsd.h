...
#define TSD_DATA_SLOW                                                                \
    ...
    O(activity_callback_thunk, activity_callback_thunk_t, activity_callback_thunk_t) \
    O(tcache_slow, tcache_slow_t, tcache_slow_t)                                     \
    O(rtree_ctx, rtree_ctx_t, rtree_ctx_t)

#define TSD_DATA_SLOW_INITIALIZER                                                                                                                   \
    /* tcache_enabled */ TCACHE_ENABLED_ZERO_INITIALIZER, /* reentrancy_level */ 0, /* thread_allocated_last_event */ 0,                            \
        /* thread_allocated_next_event */ 0, /* thread_deallocated_last_event */ 0, /* thread_deallocated_next_event */ 0,                          \
        /* tcache_gc_event_wait */ 0, /* tcache_gc_dalloc_event_wait */ 0, /* prof_sample_event_wait */ 0, /* prof_sample_last_event */ 0,          \
        /* stats_interval_event_wait */ 0, /* stats_interval_last_event */ 0, /* peak_alloc_event_wait */ 0, /* peak_dalloc_event_wait */ 0,        \
        /* prof_tdata */ NULL, /* prng_state */ 0, /* san_extents_until_guard_small */ 0, /* san_extents_until_guard_large */ 0, /* iarena */ NULL, \
        /* arena */ NULL, /* arena_decay_ticker */                                                                                                  \
        TICKER_GEOM_INIT(ARENA_DECAY_NTICKS_PER_UPDATE), /* sec_shard */ (uint8_t)-1, /* binshards */ TSD_BINSHARDS_ZERO_INITIALIZER,               \
        /* tsd_link */ {NULL}, /* in_hook */ false, /* peak */ PEAK_INITIALIZER, /* activity_callback_thunk */                                      \
        ACTIVITY_CALLBACK_THUNK_INITIALIZER, /* tcache_slow */ TCACHE_SLOW_ZERO_INITIALIZER, /* rtree_ctx */ RTREE_CTX_INITIALIZER,
...
#define TSD_DATA_FAST_INITIALIZER                                                                                                               \
    /* thread_allocated */ 0, /* thread_allocated_next_event_fast */ 0, /* thread_deallocated */ 0, /* thread_deallocated_next_event_fast */ 0, \
...
#define TSD_INITIALIZER                                                                                         \
    {                                                                                                           \
        ...
        /* state */ ATOMIC_INIT(tsd_state_uninitialized), TSD_DATA_FAST_INITIALIZER TSD_DATA_SLOWER_INITIALIZER \
    }
...
#define O(n, t, nt)                                                                                                  \
    JEMALLOC_ALWAYS_INLINE t *tsd_##n##p_get(tsd_t *tsd) {                                                           \
        ...
        assert(                                                                                                      \
            state == tsd_state_nominal || state == tsd_state_nominal_slow || state == tsd_state_nominal_recompute || \
...
static inline bool tsd_state_nocleanup(tsd_t *tsd) {
    return tsd_state_get(tsd) == tsd_state_reincarnated || tsd_state_get(tsd) == tsd_state_minimal_initialized;
}
