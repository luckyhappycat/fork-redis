...
#define TYPED_LIST(list_type, el_type, linkage)                                                           \
    ...
    static inline void list_type##_replace(list_type##_t *list, el_type *to_remove, el_type *to_insert) { \
    ...
    static inline void list_type##_concat(list_type##_t *list_a, list_type##_t *list_b) {                 \
