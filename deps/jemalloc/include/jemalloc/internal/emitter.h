...
static inline bool emitter_outputs_json(emitter_t *emitter) {
...
static inline void emitter_init(emitter_t *emitter, emitter_output_t emitter_output, write_cb_t *write_cb, void *cbopaque) {
...
static inline void emitter_json_key(emitter_t *emitter, const char *json_key) {
    if (emitter_outputs_json(emitter)) {
        ...
        emitter_printf(emitter, "\"%s\":%s", json_key, emitter->output == emitter_output_json_compact ? "" : " ");
 ...
 */
static inline void emitter_kv_note(
