...
static void tsd_prng_state_init(tsd_t *tsd) {
    /*
...
JEMALLOC_ATTR(used) BOOL(WINAPI *const tls_callback)(HINSTANCE hinstDLL, DWORD fdwReason, LPVOID lpvReserved) = _tls_callback;
#endif
