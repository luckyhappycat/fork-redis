...
JEMALLOC_NOINLINE static void *fallback_impl(std::size_t size) noexcept(IsNoExcept) {
...
template <bool IsNoExcept>
JEMALLOC_ALWAYS_INLINE void *alignedNewImpl(std::size_t size, std::align_val_t alignment) noexcept(IsNoExcept) {
...
void sizedDeleteImpl(void *ptr, std::size_t size) noexcept {
...
JEMALLOC_ALWAYS_INLINE
void alignedSizedDeleteImpl(void *ptr, std::size_t size, std::align_val_t alignment) noexcept {
    if (config_debug) {
