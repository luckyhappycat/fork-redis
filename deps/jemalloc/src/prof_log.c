...
static size_t prof_log_bt_index(tsd_t *tsd, prof_bt_t *bt) {
    ...
    if (ckh_search(&log_bt_node_set, (void *)(&dummy_node), (void **)(&node), NULL)) {
        ...
        prof_bt_node_t *new_node =
            (prof_bt_node_t *)iallocztm(tsd_tsdn(tsd), sz, sz_size2index(sz), false, NULL, true, arena_get(TSDN_NULL, 0, true), true);
...
static size_t prof_log_thr_index(tsd_t *tsd, uint64_t thr_uid, const char *name) {
    ...
    if (ckh_search(&log_thr_node_set, (void *)(&dummy_node), (void **)(&node), NULL)) {
        ...
        prof_thr_node_t *new_node =
            (prof_thr_node_t *)iallocztm(tsd_tsdn(tsd), sz, sz_size2index(sz), false, NULL, true, arena_get(TSDN_NULL, 0, true), true);
...
void prof_try_log(tsd_t *tsd, size_t usize, prof_info_t *prof_info) {
    ...
    prof_alloc_node_t *new_node =
        (prof_alloc_node_t *)iallocztm(tsd_tsdn(tsd), sz, sz_size2index(sz), false, NULL, true, arena_get(TSDN_NULL, 0, true), true);
