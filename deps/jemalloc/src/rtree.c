...
static rtree_node_elm_t *rtree_node_alloc(tsdn_t *tsdn, rtree_t *rtree, size_t nelms) {
    return (rtree_node_elm_t *)base_alloc(tsdn, rtree->base, nelms * sizeof(rtree_node_elm_t), CACHELINE);
}

static rtree_leaf_elm_t *rtree_leaf_alloc(tsdn_t *tsdn, rtree_t *rtree, size_t nelms) {
    return (rtree_leaf_elm_t *)base_alloc(tsdn, rtree->base, nelms * sizeof(rtree_leaf_elm_t), CACHELINE);
}
